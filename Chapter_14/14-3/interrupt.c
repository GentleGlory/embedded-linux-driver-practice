...
static void button_work_handler(struct work_struct *work)
{
    ...
    mdelay(200);
    printk(KERN_INFO "button_work_handler counter = %d\n",counter++);
    mdelay(200);
    printk(KERN_INFO "button_work_handler counter = %d\n",counter++);
    mdelay(200);
    printk(KERN_INFO "button_work_handler counter = %d\n",counter++);
...
{
    printk(KERN_INFO "button_irq_handler enter\n");
    ...
    printk(KERN_INFO "button_irq_handler exit\n");
    return IRQ_HANDLED;
}
